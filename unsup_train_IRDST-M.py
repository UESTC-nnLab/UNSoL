...
def main():
    ...
    ###############################################
    phases = [
        PhaseConfig(start_epoch=0, end_epoch=20, step=20, script='train_phase0_IRDST_ACM&RDIAN.py'),
        PhaseConfig(start_epoch=20, end_epoch=80, step=20, script='train_phase1_IRDST_ACM/RDIAN.py'),
        PhaseConfig(start_epoch=80, end_epoch=100, step=20, script='train_sup_IRDST-M.py'),
    ]
    
    # phases = [
    #     PhaseConfig(start_epoch=0, end_epoch=20, step=20, script='train_phase0_IRDST_MSHNet.py'),
    #     PhaseConfig(start_epoch=20, end_epoch=80, step=20, script='train_phase1_IRDST_MSHNet.py'),
    #     PhaseConfig(start_epoch=80, end_epoch=100, step=20, script='train_sup_IRDST-M.py'),
    # ]
    
    # phases = [
    #     PhaseConfig(start_epoch=0, end_epoch=20, step=20, script='train_phase0_IRDST_MSHNet.py'),
    #     PhaseConfig(start_epoch=20, end_epoch=60, step=20, script='train_phase1_IRDST_MSHNet.py'),
    #     PhaseConfig(start_epoch=60, end_epoch=100, step=40, script='train_sup_IRDST-M.py'),
    # ]
    ###############################################
