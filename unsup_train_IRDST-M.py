...
def main():
    ...
    phases = [
        PhaseConfig(start_epoch=0, end_epoch=20, step=20, script='train_phase0_IRDST.py'),
        PhaseConfig(start_epoch=20, end_epoch=80, step=20, script='train_phase1_IRDST.py'),
