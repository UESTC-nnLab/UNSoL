...
final_file = '/home/public/IRDST-M/train_pseudo_labels.txt'
candidate_file = '/home/public/IRDST-M/candidate_pseudo_labels.txt'
aug_file = '/home/public/IRDST-M/train_pseudo_labels_0.txt'
aug_dir = '/home/public/IRDST-M_AUG'
...
def generation():
    ...
    homogeneous_motion_hybridizing(final_file,aug_dir,final_file,4)
        ...
        for _ in range(num_targets_to_add):
            ...
            for idx, frame_item in enumerate(current_frames_subset):
                ...
                if is_small_target:
                    ...
                    scale = random.uniform(1.00, 1.05)
                ...
                # 更新边界框并对右下角进行+1扩张
                final_bbox = (overlay_x1_clamped, overlay_y1_clamped, overlay_x2_clamped + 2, overlay_y2_clamped + 2)
