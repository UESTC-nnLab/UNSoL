...
class Pred_vid(object):
    _defaults = {
        ...
        "model_path"        : '/home/MoPKL/logs/pre-trained_weights.pth',
    ...
    def generate(self, onnx=False):
        self.net    = model(self.num_classes, num_frame=5)
...
if __name__ == "__main__":
    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                r_image, _ = yolo.detect_image(images, crop = crop, count=count)
    ...
    if mode == "video":
        ...
        for image in tqdm(images):
            ...
            r_image,_ = yolo.detect_image(imgs, crop = crop, count=count)
