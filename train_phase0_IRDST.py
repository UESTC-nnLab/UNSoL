...
from nets.Detector import Detector as Model
...
from utils.utils_fit_phase0_IRDST import fit_one_epoch
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument('--stop_at_epoch', type=int, default=100)
    parser.add_argument('--total_epochs_trained', type=int, default=0)
    args = parser.parse_args()

    stop_at_epoch = args.stop_at_epoch
    total_epochs_trained = args.total_epochs_trained
    ...
    train_annotation_path = '/home/public/IRDST-M/train_pseudo_labels.txt'
    val_annotation_path = '/home/public/IRDST-M/val.txt'
    ...
    model = Model(num_classes=num_classes, num_frame=5)
    weights_init(model)
    ...
    if True:
        ...
        val_dataset = seqDataset(val_annotation_path, input_shape[0], 1, 'val')
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            if epoch >= stop_at_epoch:
                print(f"Reached stop_at_epoch: {stop_at_epoch}, early stopping.")
                break
